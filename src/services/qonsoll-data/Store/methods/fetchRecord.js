...
/**
 * Method helps to fetch record data from DB by query
 * @param {string} query graphql like query
 * @param {object} adapter defaultAdapter instance
 ...
 * @returns {object}
 */
const fetchRecord = async ({ query, adapter, models, options }) => {
  ...
  const commands = buildCommandsStack(queryJSON.query, 'fetchRecord', models)
